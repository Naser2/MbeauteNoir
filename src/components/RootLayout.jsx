...
function RootLayoutInner({ className, children }) {
  ...
  return (
    <MotionConfig transition={shouldReduceMotion ? { duration: 0 } : undefined}>
      <header>
        <div
         className={`absolute left-0 right-0 top-0 z-40 pt-3 px-4 text-center bg-black border-t border-purple-600`} 
        ...
        >
          <a href="https://www.amazon.com/SoftSheen-Carson-Lovely-Uplift-Bleaching-Developer/dp/B09HWP2G29/ref=sr_1_18?keywords=hair+bleach+for+black+hair&qid=1698427556&sr=8-18"><h4 className="!text-white">Shop with Massi</h4></a>
